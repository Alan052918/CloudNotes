...
public class TagControllerTest extends ControllerTest {
    ...
    void setUp() {
        ...
        mockMvc = MockMvcBuilders
                .standaloneSetup(new TagController(mockTagService, mockTagModelAssembler))
                .build();
    }
    ...
    public void getAllTags_200Ok() throws Exception {
        // given
        CollectionModel<EntityModel<Tag>> collectionModel = mockTags
                .stream()
        ...
        mockMvc
                .perform(get(BASE_PATH + TAG_PATH).contentType(MediaType.APPLICATION_JSON))
                .andDo(print())
    ...
    public void getAllTagsByNoteId_200Ok() throws Exception {
        ...
        when(mockTagModelAssembler.toCollectionModel(mockTags)).thenReturn(collectionModel);
        mockMvc
                .perform(get(BASE_PATH + NOTE_PATH + "/" + testId + "/tags")
    ...
    public void getTagById_200Ok() throws Exception {
        ...
        mockMvc
                .perform(get(BASE_PATH + TAG_PATH + "/" + testId).contentType(MediaType.APPLICATION_JSON))
                .andDo(print())
                .andExpect(MockMvcResultMatchers.status().isOk())
    ...
    public void updateTag_200Ok() throws Exception {
        ...
        mockMvc
                .perform(MockMvcRequestBuilders
                        .patch(BASE_PATH + TAG_PATH + "/" + testId)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(requestBody))
                .andDo(print())
                .andExpect(MockMvcResultMatchers.status().isOk())
    ...
    public void deleteTagById_204NoContent() throws Exception {
        ...
        mockMvc
                .perform(MockMvcRequestBuilders
                        .delete(BASE_PATH + TAG_PATH + "/" + testId)
                        .contentType(MediaType.APPLICATION_JSON))
                .andDo(print())
