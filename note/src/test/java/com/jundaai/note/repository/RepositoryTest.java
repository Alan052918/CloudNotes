...
public abstract class RepositoryTest {
    ...
    void loadFoldersNotesAndTags() {
        ...
        Folder root = mockFolderRepository.save(Folder.builder()
                .name("root")
                .createdAt(now)
                .updatedAt(now)
                .parentFolder(null)
        ...
        Folder pl = mockFolderRepository.save(Folder.builder()
        ...
        Folder ds = mockFolderRepository.save(Folder.builder()
        ...
        Note go = mockNoteRepository.save(Note.builder()
                .name("Go")
        ...
        Tag google = mockTagRepository.save(Tag.builder()
                .name("Google")
                .createdAt(now)
                .updatedAt(now)
                .notes(new ArrayList<>())
        ...
        Tag microsoft = mockTagRepository.save(Tag.builder()
                .name("Microsoft")
                .createdAt(now)
                .updatedAt(now)
                .notes(new ArrayList<>())
